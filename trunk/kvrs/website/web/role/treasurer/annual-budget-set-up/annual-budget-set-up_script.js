...
var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=9, SCRIPT_HREF="annual-budget-set-up_script.js", FULLSCR_HREF="annual-budget-set-up_fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("annual-budget-set-up_slide0009.htm", 1, 1),
   new hrefList("annual-budget-set-up_slide0006.htm", 1, 2),
   new hrefList("annual-budget-set-up_slide0007.htm", 1, 3),
   new hrefList("annual-budget-set-up_slide0001.htm", 1, 4),
   new hrefList("annual-budget-set-up_slide0002.htm", 1, 5),
   new hrefList("annual-budget-set-up_slide0010.htm", 1, 6),
   new hrefList("annual-budget-set-up_slide0003.htm", 1, 7),
   new hrefList("annual-budget-set-up_slide0005.htm", 1, 8),
   new hrefList("annual-budget-set-up_slide0008.htm", 1, 9)
);
